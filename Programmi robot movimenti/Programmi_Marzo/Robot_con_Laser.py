...
def muovi(direzione,giri):
    AS.counter=0
    dati.voluto=2200
    setta(dati.voluto,direzione)
    while(AS.counter<giri):
        time.sleep(0.01)
    setta(0,direzione)
...
while(1):
    while(1):
        if(dati.counter==0):
            if((LAD.range>220) and (LAS.range>220) and (a[dati.riga,dati.colonna+1]==0):
                movimento_30(avanti)
                break
            else:
                if((LD.range>200) and (LS.range>200)):
                    if(a[dati.riga+1,dati.colonna]==0):
                        ruota_destra()
                        break
                    elif(a[dati.riga-1,dati.colonna]==0):
                        ruota_sinistra()
                        break
                    elif(a[dati.riga+1,dati.colonna]==96):
                        ruota_destra()
                        break
            elif((LD.range>200) and (LS.range>200)):
                if((a[dati.riga+1,dati.colonna]==0)):
                    ruota_destra()
                    break
                elif((a[dati.riga-1,dati.colonna]==0)):
            ...
            if((LAD.range>220) and (LAS.range>220) and (a[dati.riga+1,dati.colonna]==0):
                movimento_30(avanti)
                break
            else:
                if((LD.range>200) and (LS.range>200)):
                    if(a[dati.riga,dati.colonna-1]==0):
                        ruota_destra()
                        break
                    elif(a[dati.riga,dati.colonna+1]==0):
                        ruota_sinistra()
                        break
                    elif(a[dati.riga,dati.colonna+1]==96):
                        ruota_destra()
                        break
            elif((LD.range>200) and (LS.range>200)):
                if((a[dati.riga,dati.colonna-1]==0)):
